...
export const SousAdminDashboard: React.FC<PageComponentProps> = ({ user, navigateTo, refreshKey }) => {
    ...
    const canViewTransactions = sousAdminUser.permissions?.can_validate_transactions ?? false;
    const canViewRequests = sousAdminUser.permissions?.can_manage_requests ?? false;
